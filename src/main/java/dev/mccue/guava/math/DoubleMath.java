...
package dev.mccue.guava.math;

import static dev.mccue.guava.base.Preconditions.checkArgument;
import static dev.mccue.guava.math.DoubleUtils.IMPLICIT_BIT;
import static dev.mccue.guava.math.DoubleUtils.SIGNIFICAND_BITS;
import static dev.mccue.guava.math.DoubleUtils.getSignificand;
import static dev.mccue.guava.math.DoubleUtils.isFinite;
import static dev.mccue.guava.math.DoubleUtils.isNormal;
import static dev.mccue.guava.math.DoubleUtils.scaleNormalize;
import static dev.mccue.guava.math.MathPreconditions.checkInRangeForRoundingInputs;
import static dev.mccue.guava.math.MathPreconditions.checkNonNegative;
